		...
		<view class="tui-cent-box">
			<view class="tui-cent-box-felx1">
				...
				<view class="class-name-left tui-line-hight" >
					<tui-countdown :time="ts" color="#fff" borderColor="#000" backgroundColor="#000" colonColor="#000" @end="endOfTime"></tui-countdown>
				</view>
			</view>
			<view class="tui-cent-box-felx1">
				<view class="class-name-left">
						...
						<view class="tui-pro-tit">
							...
							<view class="tag-tit2">
								<view class="">
									...
									<text>限量价</text>	{{item.marketPrice}}元/件
									</view>
									<!-- <view class="tag-tit2-text">
...
<script>
	...
	//请求地址
	import {getActivity,imgurl} from '../../api/request.js'
	const {log} = console
	export default {
