	...
	<view class="tui-list-title2">
		...
		<form @submit="postUpdateStore" @reset="formReset">
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor" class="tui-input" name="storeName" :placeholder="storeName" :value="StoreInfo.storeName" maxlength="50" type="text" />
				</view>
			</tui-list-cell>
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					<view class="tui-title">收货人：</view><text class="start-1">*</text>
					<input placeholder-class="tui-phcolor" class="tui-input" name="merchantsName" :placeholder="merchantsName" :value="StoreInfo.merchantsName" maxlength="50" type="text" />
				</view>
			</tui-list-cell>
			...
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor" class="tui-input" name="phone" :placeholder="phone" maxlength="11" :value="StoreInfo.phone" type="number" />
				</view>
			</tui-list-cell>
			...
			<tui-list-cell :arrow="true"  :lineLeft="false" shape="circle"   >
				<view class="tui-line-cell2">
					<view class="tui-title2" >
						...
						<input placeholder-class="tui-phcolor" class="tui-input" name="address" :placeholder="StoreInfo.address" maxlength="50" type="text"   disabled="flase"/>
						</view>
				</view>
			</tui-list-cell>
			</picker>
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor" class="tui-input" name="addressDetails" :placeholder="addressDetails"  maxlength="50" :value="StoreInfo.addressDetails"  type="text" />
				</view>
			</tui-list-cell>
		...
		<tui-list-cell :hover="false">
			<view class="tui-line-cell">
				...
				<input placeholder-class="tui-phcolor" class="tui-input" name="serviceNumber" :value="StoreInfo.serviceNumber"  maxlength="50" type="text" disabled/>
				<text></text>
			</view>
		</tui-list-cell>
...
<script>
	...
	import {loginis,getClient,postupdateClient,uploadFiles,postSaveStore,postAddressList} from '../../api/request.js'
