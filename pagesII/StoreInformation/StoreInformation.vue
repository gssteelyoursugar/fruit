<template>
	<view class="container">
		...
		<view class="tui-list-title2">
			<text>店铺信息</text><text @click="sEdit">编辑</text>
		</view>
		<form @submit="postsaveStores" @reset="formReset">
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					class="tui-input" name="storeName" :placeholder="StoreInfo.storeName" maxlength="50" type="text" disabled/>
				</view>
			</tui-list-cell>
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor" 
					class="tui-input" name="merchantsName" :placeholder="StoreInfo.merchantsName" maxlength="50" type="text" disabled />
				</view>
			</tui-list-cell>
			...
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor"
					 class="tui-input" name="phone" :placeholder="StoreInfo.phone" maxlength="50" type="text" disabled/>
				</view>
			</tui-list-cell>
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor"
					 class="tui-input" name="address" :placeholder="StoreInfo.address" maxlength="50" type="text" disabled/>
				</view>
			</tui-list-cell>
			<tui-list-cell :hover="false">
				<view class="tui-line-cell">
					...
					<input placeholder-class="tui-phcolor"
					 class="tui-input" name="address2" :placeholder="StoreInfo.addressDetails" maxlength="50" type="text" disabled/>
				</view>
			</tui-list-cell>
		...
		<tui-list-cell :hover="false">
			<view class="tui-line-cell">
				...
				<input placeholder-class="tui-phcolor" class="tui-input" name="serviceNumber" :placeholder="StoreInfo.serviceNumber" maxlength="50" type="text" disabled />
				<text></text>
			</view>
		</tui-list-cell>
...
<script>
	...
	import {loginis,getClient,postAddressList} from '../../api/request.js'
