	...
	<view class="container">
		...
		<view :class="[currentTab === 0 ? 'actineclass' : 'errorclass']">
			<view class="tui-banner-swiper">
				...
				<view class="tui-banner-tag">{{ bannerIndex + 1 }}/{{ urlList.length }}</view>
			</view>
				...
				<view class="tui-height-full">
					...
					<view class="tui-height-flex">
						<view class="tui-left-one1">
							<text class="tui-title-class">品&nbsp; &nbsp;种：</text><text class="tui-name-class" style="font-size: 24rpx;">{{shopListdata.data.classify}}</text>
						</view>
						<view class="tui-right-one">
							<text class="tui-title-class">批&nbsp;次&nbsp;号 ：</text><text class="tui-name-class" style="font-size: 24rpx;">{{shopListdata.data.officeId}}</text>
						</view>

					</view>
					<view class="tui-height-flex">
						<view class="tui-left-one1">
							<text class="tui-title-class">原产地：</text><text class="tui-name-class" style="font-size: 24rpx;">{{shopListdata.data.originAddress}}</text>
						</view>
						<view class="tui-right-one">
							<text class="tui-title-class">发&nbsp;货&nbsp;地 ：</text><text class="tui-name-class" style="font-size: 24rpx;">{{shopListdata.data.shipmentsAddress}}</text>
						</view>

					</view>
					<view class="tui-height-flex">
						<view class="tui-left-one1">
							<text class="tui-title-class">包&nbsp; &nbsp;装：</text><text class="tui-name-class" style="font-size: 24rpx;">{{shopListdata.data.packaging}}</text>
						</view>
						<view class="tui-right-one">
							<text class="tui-title-class">储藏方式：</text><text class="tui-name-class" style="font-size: 24rpx;">{{shopListdata.data.storageMode}}</text>
						</view>
		...
		<view :class="[currentTab === 1 ? 'actineclass' : 'errorclass']" style="padding-top: 100px;">
			<view class="tui-pro-detail">
				...
				<view class="tui-height-full tui-full-bac">
					...
					<view class="shuoming">
						在相关法规明确规定网络销售的鲜活易腐类商品不适用<text>“七天无理由退换货”</text>
						规则的情况下，圈果公司基于相信商品品质、信任可敬顾客的初衷，主动推出退换货服务，得到广大顾客的赞赏和支持，形成了良好互动，为提升顾客消费体验、构建和谐商业环境起到正向作用。
						为使该服务持久良性发展，更好的惠及顾客，圈果公司制定并发布了<text>《退换货规则》</text>，具体规则内容可到<text>“我的”-“我的服务”-“规则说明”</text>查阅全部内容。`,
					</view>
