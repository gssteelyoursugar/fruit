	...
	<view>
		...
		<view class="tui-mybg-box">
			...
			<view class="tui-header-center">
				...
				<!-- 已登录/未认证 -->
				<!-- <view class="tui-set-box2" v-if="ApproveStatus === 1">
					<view class="tui-icon-box " >
					</view>
					<view class="tui-icon-box " @tap="tendShop3" >
						<text class="tui-icon-text2">已认证 ></text>
					</view>
				</view> -->
				<!-- 未认证/拒绝 -->
		...
		<view class="tui-content-box">
			<view class="tui-box tui-order-box">
				<tui-list-cell padding="0" :arrow="true"  :lineLeft="false" @click="myOrder">
...
<script>
	...
	import {loginis,getClient,} from '../../api/request.js'
...
<style>
	.tui-icon-box button{border: none!important;
...
/* 模态弹窗布局 */
	...
	.warp-flex button{border: none;font-size: 30upx;}	
	/*end  */
